 ...
 * 
 */
public class AlbumViewPagerForJs extends ViewPager implements OnMovingListener,OnSlideUpListener {
	...
	public AlbumViewPagerForJs(Context context, AttributeSet attrs) {
		super(context, attrs);
