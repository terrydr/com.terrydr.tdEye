    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // 计算到圆球中心的距离，考虑20的误差
                return !(distance - (ball.getMeasuredWidth() / 2 ) * (ball.getMeasuredWidth() / 2 ) > 0);
//                break;
            case MotionEvent.ACTION_MOVE:
                ...
                if (listener != null) {
//                	Log.e("ArcSeekBarParent", "currentLevel:" + currentLevel);
                    listener.OnProgressChanged(currentLevel);
                }
                break;
            default:
                // 当手指移出或者离开View时，圆球平滑滑到最近的档次
//            	int stat = (int)currentX;
//            	int distance1 = (int) ((right - left) / LEVEL * currentLevel - currentX);
//            	Log.e("ArcSeekBarParent", "stat:" + stat);
//            	Log.e("ArcSeekBarParent", "distance1:" + distance1);
